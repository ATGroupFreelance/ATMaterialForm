    ...
    const formJson = useMemo(() => {
        return formBuilder.utils.createFieldDefBuilder(
            [
                ...
                formBuilder.createComboBox({ id: 'Countries', validation: { required: true }, tabPath: 1 }, { enumsKey: 'Countries' }),
                formBuilder.createComboBox({ id: 'ComboBoxWithEnumsID', }, { enumsKey: 'Countries' }),
                formBuilder.createComboBox({ id: 'ComboBoxEnumsless' }, { options: [{ title: 'UK', id: 'uk' }, { title: 'US', id: 'us' }] }),
